...
Explore the API reference, diagnostics, and advanced usage guides for deeper
integration and troubleshooting.

- [Core API Reference →](/api-reference/channel-api)
- [Diagnostics and Live Dashboard Overlay →](/guides-and-howtos/faqs)
- [FAQ: “How do I broadcast? What about MPMC?” →](/guides-and-howtos/faqs)
- Have a recipe to share or a tricky integration question? [Open an Issue or Suggest Edits →](https://github.com/SP8D/sp8d/issues)
