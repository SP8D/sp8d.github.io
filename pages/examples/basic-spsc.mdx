...
- [Architecture Overview](/protocol-internals/architecture-overview#architecture-at-a-glance): Canonical protocol architecture, data flow, and slot state machine.
