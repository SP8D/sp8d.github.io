...
- [SP8D FAQ & Troubleshooting: “Why isn’t my message arriving?” and more](/guides-and-howtos/faqs#general)
...
<sub className="diagram-caption">
  <strong>Diagram:</strong> SP8D architecture diagram: Producer, Consumer,
  Channel, Slots (SharedArrayBuffer Atomics), and optional Diagnostics.
</sub>
