...
For a complete guide to slot state machine internals—including slot lifecycle, state transitions, fairness, and recovery—see the [Slot State Machine](/protocol-internals/slot-state-machine#troubleshooting--debugging-checklist) documentation.
