...
See the [Diagnostics Guide →](/guides-and-howtos/faqs) for more.
...
- [Architecture Overview](/protocol-internals/architecture-overview#key-components): Canonical protocol architecture, slot state machine, and workflow.
- [Concurrency Models](/principles/concurrency-models): SPSC, MPSC, MPMC patterns and best practices.
- [Common Usage Recipes](/quickstart/common-recipes): Integration patterns and real-world examples.
- [FAQ & Diagnostics](/guides-and-howtos/faqs): Troubleshooting, diagnostics, and live overlays.
- [Quickstart Guide](/quickstart/installation): Install and get started fast.
- [File an issue or contribute](https://github.com/SP8D/sp8d): Open source contributions welcome.

---

**Next: [Go to the SP8D Quickstart Guide →](/quickstart/installation)**
