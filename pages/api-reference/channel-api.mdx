...
<Callout type="warning" title="Troubleshooting Reference">
  Common issues are listed below. If you encounter persistent problems,
  double-check your channel configuration and concurrency mode.
</Callout>
...
<Callout type="info" title="Next Steps">
  Explore diagnostics, concurrency patterns, and usage recipes to deepen your
  understanding and optimize your implementation.
</Callout>

- [Channel diagnostics & live overlays →](/guides-and-howtos/faqs)
- [Concurrency patterns and modes →](/principles/concurrency-models)
